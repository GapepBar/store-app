  ...
  void submithandler(WidgetRef ref) async {
    try {
      ...
      status.when(
        data: (value) async {
          if (value == 'valid') {
            ...
            Navigator.of(context).pushNamedAndRemoveUntil(
                '/categoryScreen', (Route<dynamic> route) => false, arguments: {'userid': _useridController.text.toString()});
          }
          else
          {
        ...
        error: (_, __) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Some error occured'), backgroundColor: Colors.red,)),
