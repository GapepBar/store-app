...
class PreviewTransactionScreen extends ConsumerStatefulWidget {
  const PreviewTransactionScreen({super.key});

  @override
  ConsumerState<PreviewTransactionScreen> createState() =>
      _PreviewTransactionScreenState();
}

class _PreviewTransactionScreenState
    extends ConsumerState<PreviewTransactionScreen> {
  Widget _buildProductList(
      BuildContext context, double scHeight, double scWidth) {
    final CartItemModel = ref.watch(transactionCartItemsProvider);

    List<CartItem> previewProducts =
        CartItemModel.transactioncartModel!.products;
